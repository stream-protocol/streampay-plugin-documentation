...
**Clone Repository**: Clone the Stream**Pay**™ WooCommerce Plugin repository from the Stream**Pay™** WooCommerce Payment Gateway.

   ```bash https://github.com/stream-protocol/woocommerce-payment-gateway.git
